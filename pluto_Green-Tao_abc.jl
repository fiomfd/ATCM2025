...
ABSTRACT: We demonstrate Pluto-based numerical visualizations that allow students to computationally explore two of the greatest results/conjectures in 21st-century number theory: the Green–Tao theorem and the abc conjecture. Using built-in primality testing and simple Julia/MATLAB/Mathematica code, we construct long arithmetic sequences of primes and enumerate abc-triplets with small radical values. Our educational goal is not to measure learning outcomes, but to allow students to witness the scale and depth of modern number-theoretic phenomena computationally, in a way that is otherwise inaccessible in traditional classroom settings.
...
- If the final digit of $x_1$ is $5$, then $k\leqq4$.
...
manifest_format = "2.0"
project_hash = "4d2ad0c0ce68f899017d3f341feb04a2d445796d"
