...
# ╔═╡ 80506fe5-a076-4936-b1f5-15182843c3dc


# ╔═╡ 5013e88a-4d63-4e58-bc04-3782e5ebc2e2
md""" 
#### Calculus II
...
# ╔═╡ 8ed00006-42be-4180-8d5f-bb066ad7345b
...
md"""
#### 1. Tangent planes of surfaces

Let $f(x,y)$ be a smooth function of two variables on a domain $D\subset\mathbb{R}^2$. Then its graph $\Gamma(f)=\bigl\{\bigl(x,y,f(x,y)\bigr) : (x,y) \in D\bigr\}$ forms a surface. Fix arbitrary $(a,b) \in D$. The tangent plane of $\Gamma(f)$ at $\bigl(a,b,f(a,b)\bigr)$ is given by an equation of the form: 

$\bigl(1,-f_x(a,b),-f_y(a,b)\bigr)\cdot\bigl(x-a,y-b,z-f(a,b)\bigr)=0,$
...
md"""
#### 2. 2D Polar Coordinate System

$(x,y)=r\cos\theta,r\sin\theta), \quad r\geqq0, \theta\in[0,2\pi].$
"""
...
md"""
#### 3. 3D Polar Coordinate System

$(x,y,z)=(r\sin\theta\cos\varphi,r\sin\theta\sin\varphi,r\cos\theta), 
\quad r\geqq0, \theta\in[0,\pi], \varphi\in[0,2\pi].$
"""
...
We explore minimal points of $f$ numerically. More precisely we investigate a critical point $\vec{x}$ such that $\nabla{f}(\vec{x})=\vec{0}$. We introduce two algorithms known as Newton's method and gradient descent. These techniques are applied for deep learning. Let $\vec{x}_0\in\mathbb{R}^n$ be the starting point of the exploration. 
...
where $s=s_n>0$ is a small parameter called a step size or a learning rate, and can change at each $n$-th step. 
"""

# ╔═╡ c010da79-7418-4d77-a476-3601538d10c8
begin
    N4=100;
	N5=100;
	for i=1:1
